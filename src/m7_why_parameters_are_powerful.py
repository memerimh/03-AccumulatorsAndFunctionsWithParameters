...
def better_draw_circles(n):
    window = rg.RoseWindow((40*n), (40*n))

    center = rg.Point((20*n), (20*n))
    for k in range(21):
...
def even_better_draw_circles(radii, number, delay):
    window = rg.RoseWindow((2*number*radii), (2*number*radii))

    center = rg.Point((number*radii), (number*radii))
...
def run_test_even_better_draw_circles():
    ...
    print('Testing  draw_circles:  See graphics window')
    print('--------------------------------------------------')
    even_better_draw_circles(5, 50, .01)
# ----------------------------------------------------------------------
